...
<body>
   <!-- header -->
    <div class="container-fluid   overflow-auto " id="nav-c" >
        ...
        <br>
        <!-- header close -->
        <div class="container-fluid"><p class="Text ">Hey! Gamer Please update these informations</p></div>
       ...
       <!-- form -->
        <div class="container shadow-lg p-5 mb-5 " id="Box">
           <!--  <form class="form" action="#" method="post" name ="uploadImage" enctype="multipart/form-data">
                ...
                <center><img src="{$final}" class="rounded-circle border border-info" width="250" height="250"></center>
                <br>
 ...
 <input type="hidden" name="MAX_FILE_SIZE" value="30000000000" />
     ...
     <form class="form" action="#" method="post" name ="Details" >
            ...
            <center><input type="submit" class="btn btn-outline-warning " value="Update" name="submit"><a href="HomeUser.php">  <input type="Button" value="Skip" class="btn btn-primary "></a></center>
            <br>
            <br>
            </form>
              <!-- form closed -->
...
if(!isset($error))
echo "<script>alert('profile details updated') ;window.location.replace('UpdateAvtar.php');</script>";
...
/*
OST['bio'];
	var_dump ($Aduser1->updateDetails("bio",$temp['bio'])) ;
	}
